    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TicketItemId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TicketNo = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tickets", x => x.TicketItemId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TicketActivityId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TicketItemId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketActivities_Tickets_TicketItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalMessageId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketMessages_Tickets_TicketItemId",
                        column: x => x.TicketItemId,
                        principalTable: "Tickets",
                        principalColumn: "TicketItemId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketActivities_TicketItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketMessages_TicketItemId",
                table: "TicketMessages",
                column: "TicketItemId");
